...
export default function Page() {
  ...
  return (
    <div style={{ fontFamily: HV, color: "#111", background: "#fff" }}>
      ...
      {/* ── HERO ── */}
      <section className="hero-pad" style={{ background: "#f5f5f0", padding: "96px 56px 88px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="hero-grid">
            {/* Left — headline, copy, CTAs, stats */}
            <div>
              <Fade>
                <div className="lbl" style={{ marginBottom: 24 }}>Advisory Service</div>
                <h1 style={{ fontSize: "clamp(38px,5.5vw,64px)", fontWeight: 800, lineHeight: 1.06, letterSpacing: "-0.03em", margin: "0 0 22px", fontFamily: HV }}>
                  <span style={{ color: GREEN }}>Not a generic CA firm —</span>{" "}
