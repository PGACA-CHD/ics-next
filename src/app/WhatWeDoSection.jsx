...
export default function WhatWeDoSection({ T, ROUTES }) {
    ...
    const features = [
        { icon: <img src="/banners and logos/Strategy First.webp" alt="Strategy first" style={{ width: 22, height: 22, objectFit: 'contain' }} loading="lazy" />, label: "Strategy first", desc: "Structure designed before you file." },
        { icon: <img src="/banners and logos/Complaince always.webp" alt="Compliance always" style={{ width: 22, height: 22, objectFit: 'contain' }} loading="lazy" />, label: "Compliance always", desc: "Every detail handled, every time." },
        { icon: <img src="/banners and logos/Time Zone alligned.webp" alt="Time zone aligned" style={{ width: 22, height: 22, objectFit: 'contain' }} loading="lazy" />, label: "Time zone aligned", desc: "Responsive support across the globe." },
        { icon: <img src="/banners and logos/Senior Led.webp" alt="Senior led" style={{ width: 22, height: 22, objectFit: 'contain' }} loading="lazy" />, label: "Senior led", desc: "Direct access to experienced advisors." },
    ];
