...
const TOOLS = [
  ...
  // ── GST & Compliance ──────────────────────────────────────────────────────
  {
    ...
    desc: 'Comprehensive TDS rate reference across all major sections — 192 to 196D. Searchable table with threshold limits, challan codes, IT Act 2025 table references, and individual/HUF vs company rates.',
  ...
  {
    href: '/tools/tcs-rates',
    icon: '🧾',
    title: 'TCS Rate Chart',
    subtitle: 'FY 2026-27 · Section 206C',
    desc: 'All TCS sub-sections under Section 206C — scrap, timber, minerals, LRS remittances (20% / 5% / 0.5%), motor vehicles, and sale of goods. IT Act 2025 mapping and Form 27EQ codes.',
    tags: ['Section 206C', 'LRS / Remittance', 'Form 27EQ', 'IT Act 2025'],
    cta: 'View TCS Rates',
    accent: '#1B4F72',
    group: 'GST & Compliance',
  },
