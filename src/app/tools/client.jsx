...
const TOOLS = [
  ...
  { href: '/tools/company-name-check', icon: 'fas fa-building', title: 'Company Name Check', subtitle: 'RUN Service · Name Availability Guide', desc: 'Guide to checking company name availability in India. Name rules, prohibited words, government portal links, and tips for getting your name approved first time.', tags: ['Ministry of Corporate Affairs', 'RUN Service', 'Company Name', 'Incorporation'], cta: 'Check Name Rules', color: 'green', group: 'Incorporation' },
];
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; font-family: Helvetica, Arial, sans-serif !important; }
        ...
        .lg-hero {
          ...
          background: url('/banners and logos/Tools page main .webp') center/cover no-repeat;
          position: relative;
        }
        ...
        .lg-cta-card {
          ...
          background: url('/banners and logos/Tools page cta -2.webp') center/cover no-repeat;
