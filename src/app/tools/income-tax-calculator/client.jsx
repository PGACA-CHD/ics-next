...
export default function Page() {
  ...
  return (
    <div style={helvetica}>
      {/* HERO — unchanged */}
      <section style={{ backgroundImage: "url('/banners and logos/Income Tax Calculator (1).webp')", backgroundSize: "cover", backgroundPosition: "center", padding: '100px 40px 64px', position: 'relative', overflow: 'hidden' }}>
