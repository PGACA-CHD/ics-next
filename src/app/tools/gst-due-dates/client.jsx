                ...
                {RETURN_TYPES.map(r => {
                  ...
                  return (
                    <button key={r} onClick={() => setReturnType(r)}
                      style={{
                        padding: '7px 14px', fontSize: 12.5, fontWeight: 600, borderRadius: 8, border: `1.5px solid ${returnType === r ? (c ? c.border : T.f) : T.bdr}`, cursor: 'pointer',
                    ...
                    return (
                      <div key={i} style={{
                        ...
                        <div style={{ textAlign: 'right', flexShrink: 0 }}>
                          ...
                          <div style={{
                            fontSize: 11.5, fontWeight: 600, marginTop: 3,
