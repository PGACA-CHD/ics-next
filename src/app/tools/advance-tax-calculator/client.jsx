...
export default function Page() {
  ...
  return (
    <div style={{ fontFamily: HV }}>
      ...
      <section className="adv-tax-page" style={{ backgroundImage: "url('/banners and logos/Advance Tax Calculator.webp')", backgroundSize: "cover", backgroundPosition: "center", padding: '100px 40px 64px', position: 'relative', overflow: 'hidden' }}>
