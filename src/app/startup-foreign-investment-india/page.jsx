...
export const metadata = {
  title: 'Foreign Investment in Indian Startups | CCPS, CCD, SAFE',
  description: "Foreign investment in Indian startups — CCPS, CCD, SAFE notes, FCGPR, FEMA valuation. Angel tax, DPIIT recognition. Ex-Big 4 CA team.",
...
export const schemaJson = JSON.stringify([{
      ...
      "@type": "Service",
      "name": "Foreign Investment in Indian Startups | CCPS, CCD, SAFE",
      "description": "Foreign investment in Indian startups — CCPS, CCD, SAFE notes, FCGPR, FEMA valuation. Angel tax, DPIIT recognition. Ex-Big 4 CA team.",
      "url": "https://www.indiacompanysetup.com/startup-foreign-investment-india",
