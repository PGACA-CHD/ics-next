    ...
    <div>
      ...
      <section style={{ backgroundImage: "url('/banners and logos/Contact Us.png')", backgroundSize: "cover", backgroundPosition: "center", padding: "100px 56px 72px", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <h1 className="font-display" style={{
            fontSize: "clamp(36px,4vw,58px)", fontWeight: 600,
            color: "#000000ff", lineHeight: 1.06, marginBottom: 16, maxWidth: 680
          }}>
            Let's talk about your<br />
            <span style={{ fontStyle: "italic", color: T.sl }}>India plans.</span>
          </h1>
          <p style={{
            fontSize: 15, color: "rgba(0, 0, 0, 0.5)", lineHeight: 1.82,
          ...
          <div style={{ display: "flex", gap: 0, flexWrap: "wrap" }}>
            {[
              ...
              <div key={item.text} style={{
                ...
                <span style={{ fontSize: 12.5, color: "rgba(0, 0, 0, 0.52)", fontWeight: 400 }}>{item.text}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "60px 56px 80px", background: T.stone }}>
        <div style={{
          ...
          display: "grid", gridTemplateColumns: "1fr 500px", gap: 48, alignItems: "start"
          ...
          <div>
            ...
            <div style={{ marginBottom: 32 }}>
              <div style={{
                ...
                letterSpacing: 1.5, color: T.f, marginBottom: 16
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {[
                  ...
                  <div key={step.n} style={{
                    ...
                    <div style={{
                      width: 28, height: 28, background: T.f, borderRadius: "50%",
            ...
            <div style={{
              ...
              <div style={{
                width: 48, height: 48, background: "rgba(255,255,255,.1)", borderRadius: 10,
                display: "flex", alignItems: "center", justifyContent: "center",
              ...
              <div style={{ flex: 1 }}>
                <div style={{
                  ...
                  color: "rgba(255,255,255,.4)", fontWeight: 600, marginBottom: 4
                }}>Free Download</div>
                <div style={{
                  fontSize: 15, fontWeight: 600, color: "#fff",
                  marginBottom: 4, lineHeight: 1.3
                }}>India Entry Starter Guide</div>
              ...
              <a href="/India-Entry-Starter-Guide.pdf" target="_blank" rel="noopener noreferrer"
                ...
                style={{
                  display: "flex", alignItems: "center", gap: 6, background: T.s,
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{
                fontSize: 10.5, fontWeight: 700, textTransform: "uppercase",
                letterSpacing: 1.5, color: T.f, marginBottom: 14
              }}>Direct Contact</div>
              {[
                ...
                <div key={c.val} style={{
                  ...
                  <div style={{
                    width: 36, height: 36, borderRadius: 9, background: "#E4F0EB",
                    display: "flex", alignItems: "center", justifyContent: "center",
                  ...
                  <div>
                    <a href={c.href} style={{
                      ...
                      color: T.ch, display: "block", textDecoration: "none", marginBottom: 2
                    }}>{c.val}</a>
            ...
            <div style={{ background: T.ch, borderRadius: 12, padding: "18px 20px" }}>
              <div style={{
                ...
                color: T.sl, fontWeight: 600, marginBottom: 6
              }}>Knowledge Partner</div>
              <div className="font-display" style={{
                fontSize: 16, fontWeight: 600,
                color: "#fff", marginBottom: 4
              }}>PGA & Co. Chartered Accountants</div>
          ...
          <div className="contact-sticky" style={{ position: "sticky", top: 90 }}>
            ...
            <div style={{
              ...
              {[
                ...
                <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{
                  ...
                  <div style={{
                    fontSize: 11, color: activeTab === tab.id ? "rgba(255,255,255,.55)" : T.lt,
            ...
            {activeTab === "calendar" && (
              <div style={{
                background: "#fff", border: `1px solid ${T.bdr}`, borderRadius: 20,
                ...
                <div style={{ padding: "32px 28px" }}>
                  ...
                  <div style={{
                    background: T.stone, borderRadius: 12, padding: "28px 24px",
                    ...
                    <p style={{
                      fontSize: 13, color: T.mid, lineHeight: 1.65,
                    ...
                    <a href={CAL_URL} target="_blank" rel="noopener noreferrer"
                      ...
                      style={{
                        display: "inline-flex", fontSize: 14, padding: "13px 28px",
                ...
                <div style={{ padding: "24px 28px" }}>
                  {status === "success" ? (
                    <div style={{ textAlign: "center", padding: "28px 0 20px" }}>
                      ...
                      <p style={{
                        fontSize: 13.5, color: T.mid, lineHeight: 1.7,
                    ...
                    <>
                      ...
                      <div style={{
                        fontSize: 10.5, fontWeight: 700, textTransform: "uppercase",
                        letterSpacing: 1.5, color: T.lt, marginBottom: 12
                      }}>Your Details</div>
                      ...
                      <div style={{
                        fontSize: 10.5, fontWeight: 700, textTransform: "uppercase",
                        letterSpacing: 1.5, color: T.lt, marginBottom: 12, marginTop: 4
                      }}>Company Details</div>
                      ...
                      <div style={{ position: "relative", marginBottom: 12 }}>
                        ...
                        <span style={{
                          ...
                          transform: "translateY(-50%)", color: T.lt, pointerEvents: "none", fontSize: 10
                        }}>▼</span>
                      </div>
