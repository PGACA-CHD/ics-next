  ...
  useEffect(() => {
    ...
    function frame(now) {
      ...
      if (elapsed >= duration) {
        ...
        if (index >= MILESTONES.length) { setIndex(0); setPct(0); }
        else { setIndex((i) => i + 1); setPct(0); }
      }
  ...
  return (
    <section className="nhero" aria-label="Introduction">
      <style dangerouslySetInnerHTML={{
        ...
        .nhero-avatars img:first-child { margin-left: 0; }
        ...
        .nhero-review-link:hover { color: #F5A828; }
        ...
        .nhero-btn-ghost {
          ...
          backdrop-filter:blur(16px); -webkit-backdrop-filter:blur(16px);
          color:rgba(255,255,255,.85); padding:14px 24px; border-radius:10px;
          font-family:${FONT_UI}; font-size:14px; font-weight:600; cursor:pointer;
        ...
        .nhero-track-item {
          ...
          padding:9px 8px; border-radius:10px; transition:background .2s ease;
        }
      ...
      <div className="nhero-wrap">
        ...
        <div>
          ...
          {/* ── Row 1: Avatars + rating + review link ── */}
          <div className="nhero-social-row">
            {/* Overlapping avatars */}
            <div className="nhero-avatars">
              <img
                src="https://assets.vakilsearch.com/ic-user-grp-zpf.svg"
                alt="Happy clients"
                style={{ width: 110, height: 34, borderRadius: 0, border: 'none', objectFit: 'contain', marginLeft: 0 }}
              />
            </div>

            {/* Star rating */}
            <div className="nhero-rating-block">
              <div className="nhero-rating-stars">
                {[1, 2, 3, 4, 5].map(n => (
                  <svg key={n} className="nhero-star" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                    fill={n <= 4 ? '#F5A828' : 'url(#half-star)'}>
                    {n === 5 && (
                      <defs>
              ...
              <span className="nhero-rating-num">4.5</span>
            </div>

            <span className="nhero-rating-sep" />

            <a
              href="https://www.google.com/search?q=pga+and+co.+reviews"
              target="_blank"
              rel="noopener noreferrer"
              className="nhero-review-link"
            >
              31+ real reviews
            </a>
          </div>
          ...
          <div className="nhero-cta-row">
            ...
            {/* Subtle vertical divider between buttons */}
            <span className="nhero-btn-divider" aria-hidden="true" />
