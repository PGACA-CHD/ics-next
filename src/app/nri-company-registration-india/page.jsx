...
export const metadata = {
  title: 'NRI Company Registration in India | FEMA, Schedule 4',
  description: "NRI company registration and investment in India. Schedule 4 FEMA, NRE/FCNR accounts, residency transition planning. Ex-Big 4 CA team.",
...
export const schemaJson = JSON.stringify([{
      ...
      "@type": "Service",
      "name": "NRI Company Registration in India | FEMA, Schedule 4",
      "description": "NRI company registration and investment in India. Schedule 4 FEMA, NRE/FCNR accounts, residency transition planning. Ex-Big 4 CA team.",
      "url": "https://www.indiacompanysetup.com/nri-company-registration-india",
