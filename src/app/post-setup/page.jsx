...
export const metadata = {
  ...
  description: "GST registration, TDS returns, payroll, ROC filings, and ongoing compliance for foreign companies in India. Ex-Big 4 CA team. Fixed monthly retainer.",
