...
const SERVICES = {
  compliance: { title: "Regulatory Compliance", badge: "Monthly retainer", tagline: "Never miss a filing deadline.", desc: "Once your company is incorporated, India's compliance calendar kicks in immediately. GST, TDS, advance tax, Ministry of Corporate Affairs filings, ROC returns — each with its own deadline and penalty structure. We manage all of this on a retainer so nothing falls through the cracks.", monthly: [["GSTR-1", "Outward supply statement — 11th of every month"], ["GSTR-3B", "Summary GST return with tax payment — 20th of every month"], ["TDS Returns", "Quarterly TDS filing (24Q, 26Q) with challan payment by 7th"], ["Advance Tax", "Quarterly instalments — June, Sep, Dec, March"]], annual: ["Form ITR-6 — Corporate income tax return", "Ministry of Corporate Affairs AOC-4 — Annual financial statements filing", "Ministry of Corporate Affairs MGT-7 — Annual return with shareholder details", "DIR-3 KYC — Director KYC renewal every year", "DPT-3 — Return of deposits and loans"] },
