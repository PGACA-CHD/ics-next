...
export const metadata = {
  title: 'Industries We Serve | SaaS, Manufacturing, Fintech, GCC',
  description: "India Company Setup serves SaaS, manufacturing, fintech, GCC/captive centres, pharma, and professional services companies entering India.",
  alternates: { canonical: 'https://www.indiacompanysetup.com/industries' },
  openGraph: {
    title: 'Industries We Serve | SaaS, Manufacturing, Fintech, GCC',
    description: "India Company Setup serves SaaS, manufacturing, fintech, GCC/captive centres, pharma, and professional services companies entering India.",
    url: 'https://www.indiacompanysetup.com/industries',
...
export const schemaJson = JSON.stringify([{
      ...
      "@type": "Service",
      "name": "Industries We Serve | SaaS, Manufacturing, Fintech, GCC",
      "description": "India Company Setup serves SaaS, manufacturing, fintech, GCC/captive centres, pharma, and professional services companies entering India.",
      "url": "https://www.indiacompanysetup.com/industries",
