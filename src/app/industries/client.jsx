...
const INDUSTRIES = [
  { icon: <img src="/banners and logos/industries we serve/SAAS.png" alt="SaaS" style={{ width: 42, height: 42, objectFit: 'contain' }} loading="lazy" />, name: 'SaaS & Technology', desc: 'GCC setup, IP structuring, ESOP plans, cost-plus pricing for APAC and US tech companies building India engineering teams.', href: '/gcc-setup-india' },
  { icon: <img src="/banners and logos/industries we serve/Manufacturing.png" alt="Manufacturing" style={{ width: 42, height: 42, objectFit: 'contain' }} loading="lazy" />, name: 'Manufacturing', desc: 'FDI route advisory, JV structuring, GST on imports, transfer pricing for component procurement from Indian subsidiaries.', href: '/foreign-company-registration-india' },
  { icon: <img src="/banners and logos/industries we serve/Financial Services.png" alt="Fintech" style={{ width: 42, height: 42, objectFit: 'contain' }} loading="lazy" />, name: 'Fintech & BFSI', desc: 'RBI-regulated entity structuring, FEMA compliance, FCA parent requirements, PE risk for financial services firms.', href: '/foreign-company-registration-india' },
  { icon: <img src="/banners and logos/industries we serve/Health and Pharma.png" alt="Healthcare" style={{ width: 42, height: 42, objectFit: 'contain' }} loading="lazy" />, name: 'Healthcare & Pharma', desc: 'Government Route FDI for pharmacy retail, automatic route for manufacturing, transfer pricing for clinical research operations.', href: '/fdi-rules-india' },
  { icon: <img src="/banners and logos/industries we serve/E commerce.png" alt="E-Commerce" style={{ width: 42, height: 42, objectFit: 'contain' }} loading="lazy" />, name: 'E-Commerce & D2C', desc: 'Marketplace vs inventory model FDI rules, GST on cross-border e-commerce, FEMA for payment gateways and cross-border settlements.', href: '/fdi-rules-india' },
