...
const steps = [
  ...
  { n: '03', title: 'Obtain DSC', time: 'Week 1–2', desc: 'All directors need a Class 3 Digital Signature Certificate from an Indian certifying authority. This is handled entirely remotely — no India visit required.' },
  { n: '04', title: 'Name Reservation — MCA RUN', time: 'Week 2', desc: 'We file your preferred company name through the MCA21 Reserve Unique Name (RUN) portal and verify availability before proceeding.' },
  ...
  { n: '06', title: 'Certificate of Incorporation', time: 'Week 3–4', desc: 'Once the ROC approves your application, you receive the Certificate of Incorporation, PAN, and TAN. Your Indian company is now officially registered.' },
];
...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section className="sec" style={{ backgroundImage: "url('/banners%20and%20logos/Australia.png')", backgroundSize: 'cover', backgroundPosition: 'center', padding: '100px 56px 92px' }}>
          ...
          <div className="hero-g" style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 64, alignItems: 'start' }}>
            <Fade>
              ...
              <p style={{ fontSize: 16, color: '#555', lineHeight: 1.78, maxWidth: 480, marginBottom: 36, fontFamily: HV }}>
                100% online. No India visit required. Expert CA support for Australia-based NRIs, Australian businesses, and founders expanding into India.
              </p>
            ...
            <Fade delay={100}>
              <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.48)', borderRadius: 16 }}>
                ...
                {[
                  ...
                  { label: 'India-Australia', text: 'DTAA in force' },
                ].map((row, i, arr) => (
