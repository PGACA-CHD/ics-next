...
const steps = [
  { n: '01', title: 'Choose Your Business Structure', time: 'Day 1', desc: 'Canada-based founders typically register a Private Limited Company, LLP, or Wholly Owned Subsidiary. We advise on the best fit based on your sector, FDI policy, and ownership plans.' },
  { n: '02', title: 'Apostille Canadian Documents', time: 'Week 1', desc: 'Canada joined the Hague Apostille Convention in January 2024. Documents can now be apostilled through Global Affairs Canada or provincial authorities, eliminating the need for Indian Embassy attestation.' },
  { n: '03', title: 'Obtain DSC', time: 'Week 1–2', desc: 'All directors need a Class 3 Digital Signature Certificate from an Indian certifying authority. The process is completed remotely — no India visit required.' },
  ...
  { n: '05', title: 'File SPICe+ Incorporation Form', time: 'Week 2–3', desc: 'The SPICe+ (INC-32) form consolidates company incorporation, DIN, PAN, TAN, and GSTIN applications into a single submission to the Ministry of Corporate Affairs.' },
  { n: '06', title: 'Certificate of Incorporation', time: 'Week 3–4', desc: 'Once the ROC approves your application, you receive the Certificate of Incorporation, PAN, and TAN. Your Indian company is officially in business.' },
];

const whyPoints = [
  ["Apostille now simple in Canada", "Canada joined the Hague Apostille Convention in January 2024 — documents apostilled via Global Affairs Canada are accepted directly by Indian authorities, no Embassy needed."],
  ["India-Canada DTAA", "India and Canada have a Double Taxation Avoidance Agreement, preventing the same income from being taxed in both countries — key for NRIs earning from Indian entities."],
  ["Deep tech talent at lower cost", "Access one of the world's largest pools of software engineers, CAs, and technical professionals at a fraction of Canadian operational costs."],
  ["100% FDI in most sectors", "Automatic Route FDI permitted in IT, consulting, manufacturing, e-commerce, and more — no government approval needed in most cases."],
...
const structures = [
  ...
  ['WOS', 'Canadian companies expanding to India', '2 (1 resident)', 'Yes — 100% ownership'],
];
...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="sec" style={{ backgroundImage: 'url("/banners%20and%20logos/Canada.png")', backgroundSize: 'cover', backgroundPosition: 'center', padding: '100px 56px 92px' }}>
          ...
          <div className="hero-g" style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 64, alignItems: 'start' }}>
            <Fade>
              ...
              <p style={{ fontSize: 16, color: '#555', lineHeight: 1.78, maxWidth: 480, marginBottom: 36, fontFamily: HV }}>
                100% online. No India visit required. Expert CA support for Canada-based NRIs, Canadian businesses, and founders expanding into India.
              </p>
            ...
            <Fade delay={100}>
              <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.48)', borderRadius: 16 }}>
                ...
                {[
                  ...
                  { label: 'Apostille Convention', text: 'Canada joined Jan 2024' },
                ].map((row, i, arr) => (
          ...
          <Fade>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontSize: 'clamp(22px,3vw,34px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 14, fontFamily: HV }}>
                What you'll need from Canada
              </h2>
              <p style={{ fontSize: 14.5, color: '#666', lineHeight: 1.75, fontFamily: HV, maxWidth: 560, margin: '0 auto' }}>
                Since January 2024, Canada is part of the Hague Apostille Convention. Documents apostilled through Global Affairs Canada or provincial authorities are accepted directly by Indian authorities.
              </p>
            </div>
          </Fade>
          ...
          <div style={{ background: GREEN, borderRadius: 18, padding: '44px 52px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 40, flexWrap: 'wrap', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ flex: 1, minWidth: 260, position: 'relative' }}>
              <h2 style={{ fontSize: 'clamp(20px,2.5vw,30px)', fontWeight: 800, color: '#fff', lineHeight: 1.15, marginBottom: 8, fontFamily: HV }}>
                Ready to register your Indian company from Canada?
              </h2>
