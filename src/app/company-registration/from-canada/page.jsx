...
const steps = [
  ...
  { n: '06', title: 'Company Registration Complete', time: 'Week 3–4', desc: 'On regulatory approval you receive your incorporation certificate and tax registration numbers. Your Indian entity is ready to operate.' },
];
            ...
            <Fade delay={100}>
              <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.48)', borderRadius: 16 }}>
                ...
                {[
                  ...
                  { label: 'Max govt. fee', val: 330, prefix: 'C$' },
                ].map((row, i, arr) => (
