...
const steps = [
  ...
  { n: '06', title: 'Company Registration Complete', time: 'Week 3–4', desc: 'The registrar approves your application and issues the incorporation certificate and tax registration numbers — your company is officially registered in India.' },
];
...
export default function Page() {
  ...
  return (
    <>
        ...
        * { box-sizing:border-box; margin:0; }
        ...
        @media(max-width:580px){
          ...
          .why-eq-grid { grid-template-columns:1fr !important; grid-auto-rows:auto !important; }
            ...
            .usa-hero {
              background-image: url("/mobile-banners/usa.webp") !important;
            }
          }
        `}</style>

      {/* HERO */}
      <section className="usa-hero sec" style={{ backgroundImage: 'url("/banners%20and%20logos/USA.webp")', backgroundSize: 'cover', backgroundPosition: 'center', padding: '100px 56px 92px' }}>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <Fade>
            <div className="sec-heading-wrap" style={{ marginBottom: 36 }}>
              ...
              <h2 style={{ fontSize: 'clamp(22px,3vw,36px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 8, fontFamily: HV }}>Why US Founders <span style={{ fontStyle: 'italic', color: '#e69819' }}>Are Setting Up in India.</span></h2>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <Fade>
            <div className="sec-heading-wrap" style={{ marginBottom: 56 }}>
              ...
              <h2 style={{ fontSize: 'clamp(22px,3vw,34px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 14, fontFamily: HV }}>What you'll need <span style={{ fontStyle: 'italic', color: '#e69819' }}>from the USA.</span></h2>
      ...
      <PricingSection country="usa" ROUTES={{ contact: '/contact' }} />
      {/* FAQ */}
