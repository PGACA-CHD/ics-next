...
const steps = [
  { n: '01', title: 'Choose Your Business Structure', time: 'Day 1', desc: 'Singapore-based founders commonly register a Private Limited Company or Wholly Owned Subsidiary in India. For professional services, an LLP may be preferred. We advise on the right fit.' },
  { n: '02', title: 'Apostille Singapore Documents', time: 'Week 1', desc: 'Singapore is a member of the Hague Apostille Convention. Documents (passport, address proof) must be apostilled through the Singapore Academy of Law (SAL) or the relevant Singapore authority before submission.' },
  { n: '03', title: 'Obtain DSC', time: 'Week 1–2', desc: 'All directors need a Class 3 Digital Signature Certificate from an Indian certifying authority. The application is fully remote — no India visit required.' },
  { n: '04', title: 'Name Reservation — MCA RUN', time: 'Week 2', desc: 'We file your preferred company name through the MCA21 Reserve Unique Name (RUN) portal and verify availability before proceeding to incorporation.' },
  { n: '05', title: 'File SPICe+ Incorporation Form', time: 'Week 2–3', desc: 'The SPICe+ (INC-32) form bundles company incorporation, DIN, PAN, TAN, and GSTIN applications in a single online submission to the Ministry of Corporate Affairs.' },
  { n: '06', title: 'Certificate of Incorporation', time: 'Week 3–4', desc: 'Upon ROC approval, you receive your Certificate of Incorporation, PAN, and TAN. Your Indian company is officially registered.' },
];

const whyPoints = [
  ["India-Singapore DTAA", "The India-Singapore Double Taxation Avoidance Agreement (in force since 1994, revised 2016) prevents double taxation on income flowing between the two countries."],
  ...
  ["Access India's tech talent", "Tap one of the world's largest pools of software engineers, CAs, and professionals at a fraction of Singapore costs."],
      ...
      <section className="sec" style={{ background: '#f5f5f0', padding: '100px 56px 92px' }}>
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          ...
          <div className="hero-g" style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 64, alignItems: 'start' }}>
            <Fade>
              <span className="lbl" style={{ marginBottom: 20 }}>Company Registration · From Singapore</span>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <Fade>
            ...
            <h2 style={{ fontSize: 'clamp(22px,3vw,36px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 6, fontFamily: HV }}>
              Why Singapore Founders Are Setting Up in India
            </h2>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <Fade>
            ...
            <h2 style={{ fontSize: 'clamp(22px,3vw,36px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 8, fontFamily: HV }}>
              From Singapore to your Certificate of Incorporation.
            </h2>
          ...
          <Fade>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontSize: 'clamp(22px,3vw,34px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 14, fontFamily: HV }}>
                What you'll need from Singapore
              </h2>
