...
const faqs = [
  ...
  { q: 'What are the ongoing compliance requirements for my Indian company?', a: 'Indian companies must file annual returns with the Ministry of Corporate Affairs, income tax returns, GST returns (if applicable), and maintain audited accounts. We offer end-to-end compliance management so you can focus on running your business.' },
];
    ...
    <>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; }
        ...
        .lbl { font-size:10.5px; letter-spacing:2.5px; text-transform:uppercase; font-weight:600; color:#000; font-family:Helvetica, Arial, sans-serif; display:block; margin-bottom:12px; }
      ...
      {/* HERO */}
      <section className="sec" style={{ backgroundImage: 'url("/banners%20and%20logos/Singapore.webp")', backgroundSize: 'cover', backgroundPosition: 'center', padding: '100px 56px 92px' }}>
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          ...
          <div className="hero-g" style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 64, alignItems: 'start' }}>
            <Fade>
              <span className="lbl">Company Incorporation · From Singapore</span>
            ...
            <Fade delay={100}>
              <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.48)', borderRadius: 16 }}>
                ...
                {[
                  ...
                  { label: 'Max govt. fee', val: 320, prefix: 'S$' },
                ].map((row, i, arr) => (
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <Fade>
            <div className="sec-heading-wrap" style={{ marginBottom: 36 }}>
              ...
              <h2 style={{ fontSize: 'clamp(22px,3vw,36px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 8, fontFamily: HV }}>Why Singapore Founders <span style={{ fontStyle: 'italic', color: '#e69819' }}>Are Setting Up in India.</span></h2>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <Fade>
            <div className="sec-heading-wrap" style={{ marginBottom: 36 }}>
              ...
              <h2 style={{ fontSize: 'clamp(22px,3vw,36px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 8, fontFamily: HV }}>From Singapore to your <span style={{ fontStyle: 'italic', color: '#e69819' }}>incorporation certificate.</span></h2>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          <Fade>
            <div className="sec-heading-wrap" style={{ marginBottom: 56 }}>
              ...
              <h2 style={{ fontSize: 'clamp(22px,3vw,34px)', fontWeight: 800, letterSpacing: '-0.025em', color: '#111', marginBottom: 14, fontFamily: HV }}>What you'll need <span style={{ fontStyle: 'italic', color: '#e69819' }}>from Singapore.</span></h2>
