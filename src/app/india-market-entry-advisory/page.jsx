...
export const metadata = {
  ...
  description: "India market entry advisory for foreign companies. Entity selection, FDI structuring, transfer pricing, and operational setup. Ex-Big 4 CA team.",
