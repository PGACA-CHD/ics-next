...
const PACKAGES = [
  ...
  { name: 'Domestic Pvt Ltd — Essential', price: 111, desc: 'Clean incorporation with SPICe+, PAN, TAN, PF/ESI for Indian founders.' },
...
const FAQS = [
  { q: 'What does the NRI Starter package fee cover?', a: 'The fee covers professional services — NRI route check, incorporation filing, MOA/AOA drafting, DIN/DSC, and all statutory registrations. Government fees and applicable taxes are disclosed upfront. DSC is included.' },
  { q: 'How long does Private Limited Company registration take in India?', a: 'For a standard case with complete documents, expect 7–12 working days from SPICe+ filing to Certificate of Incorporation.' },
  ...
  { q: 'How long does Branch or Liaison Office approval take?', a: 'Budget 6–8 weeks for the full process including RBI approval, AD-bank coordination, and MCA registration.' },
