...
const PROCESS = [
  ...
  { n: "04", title: "Incorporation Complete", time: "Wk 2–3", desc: "The registrar issues the incorporation certificate (CIN). The company legally exists. Tax registration numbers issued simultaneously. Typical time: 7–12 working days from filing." },
...
const HANDLE = [
  ["01", "Incorporation", "Ministry of Corporate Affairs incorporation document forms filing, CIN, tax registration numbers, GSTIN"],
