        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="disc-grid">
            {[
              ...
              { num: '02', title: 'Company Secretary & Ministry of Corporate Affairs', items: ['Company incorporation & incorporation document forms filing', 'FCGPR & FLA — RBI filings', 'Board resolutions & statutory registers', 'Annual company filings (MGT-7, AOC-4)'] },
